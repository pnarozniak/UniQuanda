...
{
    public class IsEmailAndNicknameAvailableHandler : IRequestHandler<IsEmailAndNicknameAvailableQuery, IsEmailAndNicknameAvailableResponseDTO>
    {
        ...
        public async Task<IsEmailAndNicknameAvailableResponseDTO> Handle(IsEmailAndNicknameAvailableQuery request, CancellationToken cancellationToken)
        {
